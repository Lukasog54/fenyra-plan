...
3. **Install + log in to the GitHub CLI**: https://cli.github.com/, then `gh auth login`.
...
- `gh release create <tag> <path-to-apk> --title "..." --generate-notes` — publish a release
  manually once you have an APK.
